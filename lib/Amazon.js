...
class AmazonScraper {
    ...
    grabAsinDetails(body) {
        ...
        try {
            output.price.base = $(`span.a-size-base`)[0]
        } catch {
        ...
        for (let key in scrapingResult) {
            try {
                ...
                if (priceSearch) {
                    ...
                    try{
                        var list = $(`div[data-asin=${key}] div.a-section.a-spacing-none.a-spacing-top-small.s-price-instructions-style > div > a > span.a-size-base.a-color-secondary`)
                        scrapingResult[key].price.base = list[0].children[0].data
                        // console.log(scrapingResult[key].price.base)
                        // scrapingResult[key].price.base = $(`div[data-asin=${key}] span.a-size-base.a-color-secondary`)[1].children[0].data
                    } catch {
                        scrapingResult[key].price.base=''
                    }
                }
                ...
                if (discountSearch) {
                    ...
                    // mxa
                    // scrapingResult[key].price.base = $(`div[data-asin=${key}] span.a-size-base.a-color-secondary`)[0].children[0].data;
